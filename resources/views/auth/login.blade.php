                        ...
                        <div class="col-lg-12">
                            <div class="p-5">
                                <div class="text-center mb-4">
                                    ...
                                    <img src="{{asset('img/logo-pn.png')}}" width="200" alt="">
                                </div>
                                @if ($errors->any())
                                ...
                                <form method="POST" action="{{ route('login') }}" class="user">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" name="email" placeholder="{{ __('Email') }}" value="{{ old('email') }}" required autofocus>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="text-center mt-2">
                                    <a class="text-danger" href="/">{{ __('back to landing page') }}</a>
                                    <p>v1.0.0</p>
                                </div>
                            </div>
                        </div>
