...
@section('main-content')
    ...
    <form method="POST" action="{{ route('topic.update.process', $data->id) }}" autocomplete="off"
                        ...
                        <div class="pl-lg-4">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="author" class="form-control" name="author"
                                            value="{{ $data->author }}" placeholder="Example : M. Faiz Triputra"
                                            required>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="form-control-label"
                                            for="short_description">{{ __('Topic Full Description') }}<span
                                                class="small text-danger">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="form-control-label"
                                            for="description">{{ __('Topic Description') }}<span
                                                class="small text-danger">*</span></label>
