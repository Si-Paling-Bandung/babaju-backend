                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="title" class="form-control" name="title" value="{{ old('title')}}" placeholder="Example : Penting nya menjaga kesehatan" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="author" class="form-control" name="author" value="{{ old('author')}}" placeholder="Example : M. Faiz Triputra" required>
                                </div>
                            </div>
                        </div>
