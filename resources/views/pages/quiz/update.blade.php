...
@section('main-content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">{{ __('Update Quiz') }}</h1>
    ...
    <form method="POST" action="{{ route('quiz.update.process', [$id_topic, $data->id]) }}" autocomplete="off"
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <select name="type" id="type" class="form-control @error('type') is-invalid @enderror">
                                            <option {{ 'pre_test' == $data->type ? 'selected' : '' }} value="pre_test">
                                                Pre Test</option>
                                            <option {{ 'post_test' == $data->type ? 'selected' : '' }} value="post_test">
                                                Post Test</option>
                                        </select>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="editor1" placeholder="type indonesian description here..."
                                            ...
                                            rows="4" cols="50" required>{!! htmlspecialchars_decode(htmlspecialchars($data->question)) !!}</textarea>
                                        @error('editor1')
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="answer_1" class="form-control" name="answer_1"
                                            value="{{ $data->answer_1 }}" placeholder="Example : olahraga" required>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="answer_2" class="form-control" name="answer_2"
                                            value="{{ $data->answer_2 }}" placeholder="Example : malas - malasan"
                                            required>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="answer_4" class="form-control" name="answer_4"
                                            value="{{ $data->answer_4 }}" placeholder="Example : merokok" required>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <select name="key" id="key" class="form-control @error('key') is-invalid @enderror">
                                            <option {{ 'answer_1' == $data->key ? 'selected' : '' }} value="answer_1">
                                                answer_1</option>
                                            <option {{ 'answer_2' == $data->key ? 'selected' : '' }} value="answer_2">
                                                answer_2</option>
                                            <option {{ 'answer_3' == $data->key ? 'selected' : '' }} value="answer_3">
                                                answer_3</option>
                                            <option {{ 'answer_4' == $data->key ? 'selected' : '' }} value="answer_4">
                                                answer_4</option>
                                        </select>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="explanation" name="explanation"
                                            rows="3">{{ $data->explanation }}</textarea>
                                    </div>
                                </div>
                            </div>
