...
<nav class="navbar navbar-light px-0 py-3">
    <h1 class="h3 mb-4 text-gray-800">{{ __('Topic') }} : {{$topic->title}}</h1>
    <ul class="navbar-nav">
        <li class="nav-item">
            <a href="{{route('lo.create', $topic->id)}}" class="btn btn-dark border-0">New LO</a>
        </li>
    </ul>
</nav>
    ...
    <div class="col order-lg-1">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-danger">LOs</h6>
            </div>
