...
@section('main-content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">{{ __('Edit Exercise') }}</h1>
    ...
    <form method="POST" action="{{ route('exercise.update.process', $id_topic) }}" autocomplete="off"
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="editor1" placeholder="type indonesian description here..." id="summernote"
                                            ...
                                            rows="4" cols="50" required>{!! htmlspecialchars_decode(htmlspecialchars($text)) !!}</textarea>
                                        @error('editor1')
